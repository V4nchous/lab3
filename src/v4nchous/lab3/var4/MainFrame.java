...
public class MainFrame extends JFrame {
    ...
    public MainFrame(Double[] coefficients) {
        ...
        JMenu propertiesMenu = new JMenu("Справка");
        ...
        aboutProgramMenuItem = propertiesMenu.add(aboutProgramAction);
    ...
    protected void openAboutProgram() {
        JOptionPane.showMessageDialog(new JFrame(), "Францкевич Иван 10 группа");
    }
